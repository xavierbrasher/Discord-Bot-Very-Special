...
export default function Commands(
  ...
  if (messageContent.match(prefix + "kick")) {
    ...
    message.channel.send(
      "https://cdn.discordapp.com/attachments/868111171222396992/906148880658362398/Z.png"
    );
    ...
    message.channel.send(
      "Does anyone want to play? <@717568547823419403> <@511281182000807951> <@438670084307812352> <@567507887992078336> <@1176674721471926394> <@517696139320098819>. From <@" +
        message.author.id +
        ">"
    );
    message.delete();
