...
export default function sendCustomEmbedMessage(content:string, title:string, message:discordJs.Message) {
    ...
    const exampleEmbed = new MessageEmbed(receivedEmbed).setTitle(title).setDescription(content).setColor(0x7635cc).setThumbnail("https://cdn.discordapp.com/attachments/847717900286033964/903961400865595443/logo_image_better_Custom.png")
